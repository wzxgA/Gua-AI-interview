...
public record WsOutbound(
    ...
    public static WsOutbound sessionReady(Long sessionId, String status) {
        return new WsOutbound("SESSION_READY", sessionId, null, status, null, null, null);
    }

    public static WsOutbound questionStart(Long sessionId, Long roundId) {
        return new WsOutbound("QUESTION_START", sessionId, roundId, null, null, null, null);
    }

    public static WsOutbound questionChunk(Long sessionId, Long roundId, String text) {
        return new WsOutbound("QUESTION_CHUNK", sessionId, roundId, null, null, null, text);
    }

    public static WsOutbound questionEnd(Long sessionId, Long roundId, String text) {
        return new WsOutbound("QUESTION_END", sessionId, roundId, null, null, null, text);
    }

    public static WsOutbound answerAck(Long sessionId, Long roundId) {
        return new WsOutbound("ANSWER_ACK", sessionId, roundId, null, null, null, null);
    }
    ...
    public static WsOutbound error(int code, String message) {
        return new WsOutbound("ERROR", null, null, null, code, message, null);
    }
}
